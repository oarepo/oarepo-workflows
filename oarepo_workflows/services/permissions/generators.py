...
def _make_query(generators: Iterable[Generator], **context: Any) -> list[Never] | Query:
...
class FromRecordWorkflow(Generator):
    ...
    @override
    def query_filter(self, record: Record | None = None, **context: Any) -> list[Never] | Query:  # type: ignore[reportIncompatibleMethodOverride]
        ...
        """
        return self._get_permissions_from_workflow(self._action, record, **context).query_filters  # type: ignore[no-any-return]
...
class IfInState(ConditionalGenerator):
    ...
    @override
    def query_filter(self, **context: Any) -> list[Never] | Query:  # type: ignore[reportIncompatibleMethodOverride]
        ...
        return cast("Query", (q_instate & then_query) | (~q_instate & else_query))
...
class SameAs(Generator):
    ...
    def query_filter(self, *, policy: RecordPermissionPolicy, **context: Any) -> list[Never] | Query:  # type: ignore[reportIncompatibleMethodOverride]
        """Search filters."""
