...
class SameAs(Generator):
    ...
    def _generators(self, *, policy: RecordPermissionPolicy, **context: Any) -> list[Generator]:
    ...
    def needs(self, *, policy: RecordPermissionPolicy | None = None, **context: Any) -> list[Need]:
        ...
        needs = [generator.needs(policy=policy, **context) for generator in self._generators(policy=policy, **context)]
    ...
    def excludes(self, *, policy: RecordPermissionPolicy | None = None, **context: Any) -> list[Need]:
        ...
        excludes = [
            generator.excludes(policy=policy, **context) for generator in self._generators(policy=policy, **context)
        ]
