...
class RequestPolicyWorkflowCreators(Generator):
    ...
    def _requesters_generator(self, workflow: Workflow, workflow_request: WorkflowRequest, **kwargs: Any) -> Generator:
    ...
    def needs(self, **context: Any) -> Sequence[Need]:
        ...
        try:
            ...
            generator = self._requesters_generator(workflow, workflow_request, **context)
    ...
    def query_filter(
        ...
        try:
            context = self._kwargs_parser(**context)
            generator = self._requesters_generator(record=record, request_type=request_type, **context)
